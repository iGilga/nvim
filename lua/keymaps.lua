...
nnoremap({ 'bs', ':BufferClose<cr>', opts })
nnoremap({ 'bb', ':BufferPick<cr>', opts })
nnoremap({ 'bn', ':BufferOrderByBufferNumber<cr>', opts })
nnoremap({ 'bd', ':BufferOrderByDirectory<cr>', opts })
nnoremap({ 'bl', ':BufferOrderByLanguage<cr>', opts })
